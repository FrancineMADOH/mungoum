...
abstract class AppLocalizations {
  ...
  /// No description provided for @eightDays.
  ///
  /// In en, this message translates to:
  /// **'The 8 days'**
  String get eightDays;
  ...
  /// No description provided for @culturalMeaning.
  ///
  /// In en, this message translates to:
  /// **'Cultural meaning'**
  String get culturalMeaning;
  ...
  ///
  /// In en, this message translates to:
  /// **'Mungoum implements the traditional Nguemba calendar from Bamougoum village, West Region of Cameroon.'**
  String get appDescription;

  /// No description provided for @calendarSource.
  ///
  /// In en, this message translates to:
